  ...
  return (
    <div id="about">
      <p>
        ...
        their constellation diagram, in any key or interval.
      </p>
      <p>
      ...
      <p>
        ...
        with a white background while the additional non-modal pitch classes are
        shaded. For popular scales and modes, we have listed their names.
      </p>
      <p>Additional features:</p>
      <ul>
        <li>
          The number to the left of the scale is the decimal number of the
          binary representation of the scale (the highest with regards to
          rotation). For example, the pentatonic scale in binary is
          101010010100, which is 2708 in decimal.
        </li>
        <li>
          If a symmetry icon is located to the right of the scale, this means
          the scale has bilateral symmetry for at least one pitch class (though
          not necessarily a mode).
        </li>
        <li>
          Along with the possible names for a scale will be listed the symmetric
          compression of the scale. For example, the first scale of 4 notes
          (#2340) has D4 dihedral symmetry and so is reduced to just 1 mode and
          3 pitch classes.
        </li>
        <li>
        ...
        <li>
          You can choose both key and interval note representations. We are
          currently disregarding temperment and consider, for instance, g sharp
          the same as a flat.
        </li>
      </ul>
    </div>
